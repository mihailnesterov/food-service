 ...
 * @returns JSX
 */
const BreadcrumbsProduct: FC = () => {
	return(
        <ul className="uk-breadcrumb product-breadcrumb">
            <li><Link to="/">Главная</Link> <Chevron /></li>
            <li><Link to="/catalog">Каталог</Link> <Chevron /></li>
            <li><Link to="/catalog">Чай</Link> <Chevron /></li>
            <li><span className="uk-active">Чай Принцесса Нури</span></li>
        </ul>
    );
};
