...
/**
 * Мини-корзина (ссылка на корзину в меню)
 * @param props IMiniCart
 * @returns JSX
 */
const MiniCart: FC<IMiniCart> = (props: IMiniCart) => {

    // props
    const {handleGoToCart, classlist} = props;
    // store
    ...
    useEffect(() => {
        fetchCart(cartData); // инициализация корзины в store
    }, []);
